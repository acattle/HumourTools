...
class EATGraph(object):
    def __init__(self, eat_pajek_loc):
        ...
        neg_log_proportions = {}
        for stimuli, response, weight in self.graph.edges_iter(data='weight', default=0):
        ...
        set_edge_attributes(self.graph, "weight",weights_as_proportions)
        set_edge_attributes(self.graph, "-log weight", neg_log_proportions)
