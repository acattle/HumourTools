...
def get_alliteration_and_rhyme_features(document):
    """
        ...
        :return: a tuples representing the extracted alliteration and rhyme features in the form (alliteration_num, max_alliteration_len, rhyme_num, max_rhyme_len)
    ...
    return (alliteration_num, max_alliteration_len, rhyme_num, max_rhyme_len)